    ...
    <main className="flex min-h-screen w-full flex-col bg-cream">
      ...
      <section className="mx-auto flex max-w-7xl flex-col gap-4 px-6 py-12">
        <AnimateOnScroll className="flex flex-col gap-4" direction="up">
          <h1 className="font-bold font-display text-2xl text-text-dark uppercase tracking-wide">{t("contact.termsTitle")}</h1>
          ...
          <div className="flex flex-col gap-3 font-sans text-sm text-text-muted leading-relaxed">
            <div>
              <h2 className="mb-1 font-semibold text-text-dark">{t("contact.termsAccountsTitle")}</h2>
            ...
            <div>
              <h2 className="mb-1 font-semibold text-text-dark">{t("contact.termsContentTitle")}</h2>
              <p>{t("contact.termsContentBody")}</p>
            </div>
            <div>
              <h2 className="mb-1 font-semibold text-text-dark">{t("contact.termsDisclaimerTitle")}</h2>
