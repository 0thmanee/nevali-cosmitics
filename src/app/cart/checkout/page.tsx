      ...
      <section className="flex-1 px-4 pb-16 pt-[72px]">
        <div className="mx-auto w-full max-w-7xl">
          <nav className="mb-6 font-sans text-sm text-stone-500">
            ...
            <span className="mx-2">/</span>
            <span className="font-medium text-text-dark">{t("checkoutPage.breadcrumbCheckout")}</span>
          </nav>
          <h1 className="mb-2 font-serif text-3xl font-bold text-text-dark">{t("checkoutPage.title")}</h1>
          <p className="mb-3 max-w-2xl font-sans text-sm text-stone-600">{t("checkoutPage.intro")}</p>
          <p className="mb-8 max-w-2xl rounded-sm border border-cream-dark bg-white px-4 py-3 font-sans text-sm text-stone-600">
            <span className="font-semibold text-text-dark">{t("checkoutPage.guestNoteBold")}</span>{" "}
