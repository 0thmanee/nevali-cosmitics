    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="grid grid-cols-2 xl:grid-cols-4 gap-3">
        {[0, 1, 2, 3].map((i) => (
          <div
            key={i}
            className="flex items-center justify-between bg-white border border-[#d8d0c4] rounded-[14px] px-[22px] py-5"
          >
        ...
        <div className="bg-white border border-[#d8d0c4] rounded-2xl overflow-hidden">
          ...
          {[0, 1, 2, 3, 4].map((i) => (
            <div key={i} className="flex items-center gap-4 px-5 py-3.5 border-b border-[#F5F5F3] last:border-0">
              <div className="w-11 h-11 rounded-[10px] bg-[#d8d0c4] animate-pulse shrink-0" />
              <div className="flex flex-col gap-1.5 flex-1">
                <div className="h-3 w-40 bg-[#d8d0c4] rounded-full animate-pulse" />
                <div className="h-2.5 w-24 bg-[#d8d0c4] rounded-full animate-pulse" />
              </div>
              <div className="h-5 w-16 bg-[#d8d0c4] rounded-full animate-pulse" />
            </div>
          ))}
        </div>
