...
export async function submitProductInquiry(input: InquiryInput) {
	...
	throw new Error(
		"Product inquiries are no longer supported. Please use the cart to place your order.",
	);
}
...
export async function submitCartQuoteRequests(input: {
	...
	throw new Error(
		"Quote requests are no longer supported. Please use the cart to place your order.",
	);
}
