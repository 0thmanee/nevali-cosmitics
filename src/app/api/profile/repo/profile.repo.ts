...
import type { OnboardingInput, PublicProducerProfile } from "../schemas/profile.schema";
...
export async function getPublicProducerByOrgSlug(slug: string): Promise<PublicProducerProfile | null> {
...
export const getOrganizationSlugByUserId = cache(async (userId: string): Promise<string | null> => {
