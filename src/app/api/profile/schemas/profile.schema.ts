...
export const onboardingSchema = z
	.object({
		...
		publicTagline: z.string().max(200).optional(),
		businessDescription: z.string().max(8000).optional(),
		exportMarkets: z.string().max(500).optional(),
		valuesHighlight: z.string().max(600).optional(),
...
/** Safe subset for the public producer page (no PII). */
