...
export type LocalizedContent = { title: string; description: string; topics: string[]; modules: Module[] };
export type Course = {
  slug: string; tag: string; duration: string; level: string; students: string; free: boolean;
...
export const COURSES: Course[] = [
  {
    ...
    i18n: {
      en: {
        ...
        description: "Learn the essential paperwork behind every international shipment — commercial invoices, certificates of origin, packing lists, and how to prepare them correctly for EU and GCC markets.",
        topics: ["Commercial invoices", "Certificates of origin", "Packing lists", "Customs declarations"],
        modules: [
          {
...
**For artisan rugs:** Roll tightly, wrap in kraft paper, then polypropylene. Mark each roll with a reference number matching your packing list.`,
      ...
      fr: {
        ...
        description: "Apprenez les documents essentiels pour chaque expédition internationale — factures commerciales, certificats d'origine, listes de colisage, et comment les préparer correctement pour les marchés européens et du Golfe.",
        topics: ["Factures commerciales", "Certificats d'origine", "Listes de colisage", "Déclarations en douane"],
        modules: [
          {
            title: "Qu'est-ce que la documentation d'exportation et pourquoi est-elle importante",
            duration: "8 min",
...
**Pour les tapis artisanaux :** Roulez serré, enveloppez dans du papier kraft puis du film polypropylène. Marquez chaque rouleau avec un numéro de référence correspondant à votre liste de colisage.`,
      ...
      ar: {
        ...
        description: "تعلّم الوثائق الأساسية لكل شحنة دولية — الفواتير التجارية، شهادات المنشأ، قوائم التعبئة، وكيفية إعدادها بشكل صحيح للأسواق الأوروبية وأسواق الخليج.",
        topics: ["الفواتير التجارية", "شهادات المنشأ", "قوائم التعبئة", "التصاريح الجمركية"],
        modules: [
          {
  ...
  },
  {
    ...
    i18n: {
      en: {
        ...
        description: "Discover how packaging decisions affect your product's chances of clearing customs and impressing buyers. Covers labelling standards, material requirements, and presentation for global retail.",
        topics: ["EU labelling standards", "Material compliance", "Retail packaging", "Barcode & traceability"],
        modules: [
          {
...
Add a QR code linking to your nevali artisan profile. This lets end consumers discover your story and craft process. Buyers love this — it adds perceived value without adding cost.`,
      ...
      fr: {
        ...
        description: "Découvrez comment vos décisions d'emballage influencent vos chances de passer la douane et d'impressionner les acheteurs. Couvre les normes d'étiquetage, les exigences matérielles et la présentation pour la vente au détail mondiale.",
        topics: ["Normes d'étiquetage UE", "Conformité des matériaux", "Emballage retail", "Code-barres & traçabilité"],
        modules: [
          {
            title: "Pourquoi l'emballage fait partie de votre stratégie d'exportation",
            duration: "6 min",
...
Ajoutez un QR code renvoyant vers votre profil artisan nevali. Les consommateurs finaux peuvent ainsi découvrir votre histoire et votre processus. Les acheteurs adorent cela — cela ajoute de la valeur perçue sans coût supplémentaire.`,
      ...
      ar: {
        ...
        description: "اكتشف كيف تؤثر قرارات التغليف على فرص اجتياز الجمارك وإعجاب المشترين. يشمل معايير الوسم، متطلبات المواد، وعرض المنتجات في تجارة التجزئة العالمية.",
        topics: ["معايير الوسم الأوروبية", "مطابقة المواد", "تغليف التجزئة", "الباركود والتتبع"],
        modules: [
          {
