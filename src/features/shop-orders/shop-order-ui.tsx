...
const STATUS_STYLES: Record<string, { bg: string; color: string; border: string }> = {
  ...
  SHIPPED: {
    ...
    border: "1px solid color-mix(in srgb, var(--color-forest-mid) 35%, transparent)",
  },
  NEW: {
...
export function ShopOrderStatusBadge({ status, t }: { status: string; t: Translator }) {
...
export function shopOrderLinesPreview(order: AdminShopOrderListRow, max = 2): string {
