    ...
    <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                <path d="M8 1.5l1.5 4.5H14l-3.7 2.7 1.4 4.3L8 10.3l-3.7 2.7 1.4-4.3L2 6h4.5L8 1.5z" stroke="#727272" strokeWidth="1.3" strokeLinejoin="round" />
              </svg>
            </div>
            <div>
              <p className="font-sans font-bold text-sm text-[#727272]">Active & Certified</p>
      ...
      <div className="rounded-xl overflow-hidden" style={{ background: "white", border: "1px solid #d8d0c4" }}>
        ...
        <div className="p-5 flex flex-col gap-2">
          {isLoading && (
            <p className="font-sans text-[12px] text-[#727272] py-2">Loading documents…</p>
          )}
          {isError && (
            <p className="font-sans text-[12px] text-[#f87171] py-2">Failed to load documents.</p>
          )}
          {!isLoading && !isError && certifications.length === 0 && (
            <p className="font-sans text-[12px] text-[#727272] py-2">No documents yet. Upload certifications below or on the Certification page.</p>
          )}
          {!isLoading &&
                ...
                <div key={doc.id} className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-2 min-w-0">
                    <svg width="13" height="13" viewBox="0 0 13 13" fill="none" className="shrink-0">
                      <rect x="2" y="1" width="9" height="11" rx="1.5" stroke="#727272" strokeWidth="1.1" />
                      <line x1="4.5" y1="5" x2="8.5" y2="5" stroke="#727272" strokeWidth="1.1" strokeLinecap="round" />
                      <line x1="4.5" y1="7.5" x2="7" y2="7.5" stroke="#727272" strokeWidth="1.1" strokeLinecap="round" />
                    </svg>
                    <a
                      href={doc.fileUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="font-sans text-[12px] text-[#000000] truncate hover:underline block min-w-0"
                    >
                      {doc.name}
                    </a>
                  </div>
                  <span
                    ...
                    style={
                      isVerified
                        ? { background: "rgba(0,0,0,0.85)", color: "#727272", border: "1px solid rgba(200,150,60,0.3)" }
                        : isRejected
