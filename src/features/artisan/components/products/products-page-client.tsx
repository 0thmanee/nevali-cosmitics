...
export function ProductsPageClient() {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      />
      {isLoading ? (
        <div className="bg-white border border-[#f0e8dc] rounded-xl py-12 text-center font-sans text-sm text-text-muted">
          Loading products…
        </div>
      ) : isError ? (
        <div className="bg-white border border-[#f0e8dc] rounded-xl py-12 text-center font-sans text-sm text-red-500">
