...
export function ProductCertificationsSection({ productId, productName, certifications }: Props) {
  ...
  return (
    <div className="rounded-2xl overflow-hidden shadow-sm" style={cardStyle}>
      <div className="px-6 py-4 border-b border-[#f0e8dc] flex flex-col gap-1">
      ...
      <div className="px-6 py-4 border-b border-[#f0e8dc] flex flex-col sm:flex-row sm:flex-wrap sm:items-center sm:justify-between gap-3">
        <div className="flex flex-col gap-2">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <input
              ...
              className="font-sans text-sm rounded-xl px-3 py-2 border border-[#f0e8dc] w-40"
            />
            <button
              type="button"
              onClick={() => {
          ...
          <p className="font-sans text-[11px] text-[#7a4d38]">PDF or image only (JPEG, PNG, WebP). Max 10 MB.</p>
          {fileError && (
