...
export const productFormInputBase =
  "font-sans text-sm text-[#000000] rounded-sm px-3.5 py-2.5 outline-none w-full transition-colors focus:ring-2 focus:ring-[#000000]/20 focus:border-[#000000]";
...
export const productFormSectionBorder = { borderColor: "#d8d0c4" } as const;
