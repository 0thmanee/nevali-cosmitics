    ...
    <div className="flex flex-col gap-3 max-w-2xl">
      {SUPPORT_FAQ.map((faq, i) => (
        ...
        >
          ...
          >
            <span className="font-sans font-semibold text-sm text-[#2a0f05] leading-snug">
              {faq.q}
            </span>
            <div
          ...
          {openFaqIndex === i && (
            <p className="font-sans text-[13px] text-[#7a4d38] leading-relaxed px-5 pb-5">
              {faq.a}
            </p>
          )}
        </div>
      ...
      >
        <div>
          <p className="font-sans font-semibold text-[15px] text-[#2a0f05]">
            Still need help?
          </p>
          <p className="font-sans text-sm text-[#7a4d38] mt-0.5">
