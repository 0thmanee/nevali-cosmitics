    ...
    return (
      <div className="max-w-2xl">
        ...
        >
          ...
          <div>
            <h3 className="font-serif font-bold text-[18px] text-[#2a0f05]">
              Ticket Submitted
            </h3>
            <p className="font-sans text-sm text-[#7a4d38] mt-1 max-w-sm">
    ...
    <div className="max-w-2xl">
      ...
      >
        <div className="px-5 py-4 border-b" style={{ borderColor: "#f0e8dc" }}>
          <h3 className="font-serif font-bold text-[15px] text-[#2a0f05]">
        ...
        <div className="p-5 flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="font-sans text-sm text-[#2a0f05] rounded-xl px-3.5 py-2.5 outline-none w-full"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <select
                ...
                className="font-sans text-sm text-[#2a0f05] rounded-xl px-3.5 py-2.5 outline-none w-full appearance-none"
                style={{ background: "#F5F0E8", border: "1px solid #f0e8dc" }}
              >
          ...
          <button
            ...
            style={{
              background: canSubmit && !isSubmitting ? "#1a0500" : "#7a4d38",
            }}
          >
