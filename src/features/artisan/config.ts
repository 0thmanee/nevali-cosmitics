...
export const PRODUCER_NAV_ITEMS = [
	...
	{
		labelKey: "artisanPortal.nav.profile",
		href: "/artisan/profile",
		badge: null,
	},
	{
		labelKey: "artisanPortal.nav.products",
		href: "/artisan/products",
		badge: null,
	},
	{
		labelKey: "artisanPortal.nav.journal",
		href: "/artisan/articles",
		badge: null,
	},
	{
		labelKey: "artisanPortal.nav.orders",
		href: "/artisan/orders",
		badge: null,
	},
	{
		labelKey: "artisanPortal.nav.certification",
		href: "/artisan/certification",
		badge: null,
	},
	{
		labelKey: "artisanPortal.nav.training",
		href: "/artisan/training",
		badge: null,
	},
	{
		labelKey: "artisanPortal.nav.support",
		href: "/artisan/support",
		badge: null,
	},
	{
		labelKey: "artisanPortal.nav.alerts",
...
export function getPageTitle(
	...
	switch (pathname) {
		case "/artisan":
			return {
				key: firstName
					? "artisanPortal.title.morningWithName"
					: "artisanPortal.title.morning",
		...
		default:
			if (
				pathname.startsWith("/artisan/articles/") &&
