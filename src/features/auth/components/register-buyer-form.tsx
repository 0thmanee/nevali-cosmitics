			...
			<div className="flex flex-col gap-6">
				<div className="flex flex-col gap-4">
					...
					<AuthField
						error={
							passwordMismatch
								? t("registerBuyer.passwordsMismatch")
								: undefined
						}
				...
				<div className="flex flex-col gap-4">
					<button
						...
						onClick={async () => {
							...
							if (res.error) {
								setSubmitError(
									res.error.message ?? t("registerBuyer.registrationFailed"),
								);
								return;
							}
					...
					>
						{submitting
							? t("registerBuyer.creatingAccount")
							: t("registerBuyer.createBuyerAccount")}
					</button>
					{SHOW_MULTI_PRODUCER_EXPERIENCE ? (
						<Link
