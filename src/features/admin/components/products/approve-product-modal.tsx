    ...
    >
      ...
      >
        <div className="px-5 py-4 border-b" style={{ borderColor: "#d8d0c4" }}>
          <h3 id="approve-modal-title" className="font-serif font-bold text-[15px] text-[#000000]">
            Approve product
          </h3>
          <p className="font-sans text-[12px] text-[#727272] mt-0.5">{productName}</p>
        </div>
        <div className="p-5 flex flex-col gap-4">
          <p className="font-sans text-[11px] font-bold tracking-[0.12em] text-[#727272] uppercase">
            How can buyers pay?
          </p>
            ...
            {OPTIONS.map((opt) => (
              ...
              >
                ...
                <span className="min-w-0">
                  <span className="font-sans font-semibold text-sm text-[#000000] block">{opt.label}</span>
                  <span className="font-sans text-[12px] text-[#727272] mt-0.5 block">{opt.hint}</span>
                </span>
              </label>
            ))}
          </div>
          <div className="flex items-center gap-3 pt-1">
            ...
            <button
              ...
              onClick={onCancel}
              disabled={isSubmitting}
              className="font-sans text-sm font-medium text-[#727272] hover:text-[#000000] transition-colors disabled:opacity-60"
            >
              Cancel
            </button>
          </div>
