  ...
  return (
    <div className="p-4 lg:p-6 flex flex-col gap-6">
      <nav className="flex items-center gap-2 text-sm">
        ...
        <span className="font-sans text-[#7a4d38]/60">/</span>
        <span className="font-sans font-medium text-[#2a0f05]">New module</span>
      </nav>
      ...
      {!createdModule ? (
        <div className="rounded-2xl overflow-hidden shadow-sm" style={cardStyle}>
          <div className="px-6 py-4 border-b border-[#f0e8dc]">
            <h2 className="font-serif font-bold text-[15px] text-[#2a0f05]">New module</h2>
          ...
          <form onSubmit={handleCreateModule} className="p-6 flex flex-col gap-4">
            ...
            <div>
              ...
              />
              <p className="font-sans text-[11px] text-[#7a4d38] mt-1">Leave empty to add at the end.</p>
            </div>
        ...
        <>
          ...
          <div className="rounded-2xl overflow-hidden shadow-sm" style={cardStyle}>
            <div className="px-6 py-4 border-b border-[#f0e8dc] flex items-center justify-between gap-3">
              <div>
                <h2 className="font-serif font-bold text-[15px] text-[#2a0f05]">{createdModule.title}</h2>
                {createdModule.description && (
                  <p className="font-sans text-[12px] text-[#7a4d38] mt-1">{createdModule.description}</p>
                )}
              </div>
              <span className="font-sans text-[11px] font-semibold text-[#C8963C]">Module created</span>
            </div>
          </div>
